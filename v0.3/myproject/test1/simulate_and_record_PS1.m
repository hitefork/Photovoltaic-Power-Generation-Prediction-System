...
function [current_samples, voltage_samples, product_samples,Vstc,Istc,Pstc] = simulate_and_record_PS1(my_g,my_t)
    % 创建存储结果的数组
    ...
    for i = 1:length(G) %循环五次
        ...
        %设置G
        set_param('PVarray_PS1/Constant', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant1', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant2', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant3', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant8', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant9', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant10', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant11', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant22', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant18', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant17', 'Value', num2str(G(i)));
        set_param('PVarray_PS1/Constant16', 'Value', num2str(G(i)));

        %设置T
        set_param('PVarray_PS1/Constant7', 'Value', num2str(T(i)));
