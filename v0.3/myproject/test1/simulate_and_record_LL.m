...
function [current_samples, voltage_samples, product_samples,Vstc,Istc,Pstc] = simulate_and_record_LL(my_g,my_t)
    % 创建存储结果的数组
    ...
    for i = 1:length(G) %循环五次
        ...
        %设置G
        set_param('PVarray_LL/Constant', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant1', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant2', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant3', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant8', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant9', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant10', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant11', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant22', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant18', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant17', 'Value', num2str(G(i)));
        set_param('PVarray_LL/Constant16', 'Value', num2str(G(i)));

        %设置T
        set_param('PVarray_LL/Constant7', 'Value', num2str(T(i)));
