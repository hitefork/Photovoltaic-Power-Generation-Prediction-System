...
r_tt=2/15;%训练集占比
num_yz=320;%验证集数目
x_train=cat(1,x(id(1,1:r_tt*num_sample/4),:),x(id(2,1:r_tt*num_sample/4)+num_sample/4,:),x(id(3,1:r_tt*num_sample/4)+num_sample/4*2,:),x([901:920 961:980],:));%901-920/961-980//1081-1100/1141-1160
y_train=cat(1,y(id(1,1:r_tt*num_sample/4),:),y(id(2,1:r_tt*num_sample/4)+num_sample/4,:),y(id(3,1:r_tt*num_sample/4)+num_sample/4*2,:),y([901:920 961:980],:));
x_test=cat(1,x(id(1,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4),:),x(id(2,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4)+num_sample/4,:),x(id(3,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4)+num_sample/4*2,:),x([921:960 981:1020],:));
y_test=cat(1,y(id(1,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4),:),y(id(2,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4)+num_sample/4,:),y(id(3,r_tt*num_sample/4+1:r_tt*num_sample/4+num_yz/4)+num_sample/4*2,:),y([921:960 981:1020],:));
