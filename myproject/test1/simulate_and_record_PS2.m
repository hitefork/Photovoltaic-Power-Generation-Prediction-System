...
function [current_samples, voltage_samples, product_samples,Vstc,Istc,Pstc] = simulate_and_record_PS2(my_g,my_t)
    % 创建存储结果的数组
    ...
    for i = 1:length(G) %循环五次
        ...
        %设置G
        set_param('PVarray_PS2/Constant', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant1', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant2', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant3', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant8', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant9', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant10', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant11', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant22', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant18', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant17', 'Value', num2str(G(i)));
        set_param('PVarray_PS2/Constant16', 'Value', num2str(G(i)));

        %设置T
        set_param('PVarray_PS2/Constant7', 'Value', num2str(T(i)));
